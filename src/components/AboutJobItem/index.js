...
class AboutJobItem extends Component {
    ...
    if (jobDataDetails.length >= 1) {
      ...
      return (
        <>
          <div className="jobItemContainer">
            ...
            <div className="secondPartContainer">
              <div className="descriptionVisitContainer">
                <h1 className="descriptionJobHeading">Description</h1>
                <a className="visitAnchor" href={companyWebsiteUrl}>
            ...
            <ul className="ulJobDetailsContainer">
              {skills.map(eachItem => (
                <li className="liJobDetailsContainer" key={eachItem.name}>
                  <img
            ...
            <div className="companyLifeImgContainer">
              <div className="lifeHeadingParaContainer">
          ...
          <ul className="similarJobsUlContainer">
  ...
  renderJobFailureView = () => (
    <div className="jobDetailsFailureView">
      <img
      ...
      <div className="btnContainerFailure">
        <button
          type="button"
          className="failureJobDetailsBtn"
  ...
  renderJobLoadingView = () => (
    <div className="jobDetailsLoader" data-testid="loader">
  ...
  render() {
    return (
      <>
        <Header />
        <div className="jobDetailsViewContainer">{this.renderJobDetails()}</div>
      </>
    )
  }
}
