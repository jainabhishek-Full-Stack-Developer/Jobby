...
class AllJobs extends Component {
    ...
    if (responseSuccess) {
      ...
      return (
        <div className="profileContainer">
          <img src={profileImageUrl} className="profileIcon" alt="profile" />
  ...
  onGetProfileFailureView = () => (
    <div className="failureButtonContainer">
      <button
        className="failureButtonContainer"
        type="button"
  ...
  onGetJobsFailureView = () => (
    <div className="failureImgButtonContainer">
      <img src={failureViewImg} alt="failure view" className="failureImg" />
      <h1 className="failureHeading">Oops! Something Went Wrong</h1>
      <p className="failureParagraph">
        We cannot seem to find the page you are looking for
      </p>
      <div className="jobsFailureButtonContainer">
        <button
          type="button"
  ...
  onGetJobsView = () => {
    ...
    return noJobs ? (
      ...
      <ul className="ulJobItemContainer">
  ...
  onGetCheckBoxesView = () => (
    <ul className="checkBoxesContainer">
      {employmentTypesList.map(eachItem => (
        <li className="liContainer" key={eachItem.employmentTypeId}>
          <input
            className="input"
  ...
  onGetRadioButtonView = () => (
    <ul className="radioButtonContainer">
      {salaryRangesList.map(eachItem => (
        <li className="liContainer" key={eachItem.salaryRangeId}>
          <input
            className="radio"
